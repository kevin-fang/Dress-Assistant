...
//helper method necessary for NeoPixels to show lights
void showStrips() {
  topDrawerLED.show();
...
//turns LED strip second from the top green
void secondGreen() {
  for(uint16_t i=0; i<NUM_LEDS; i++) {
    topDrawerLED.setPixelColor(i, topDrawerLED.Color(0,0,0));
...
//turns LED strip third from the top green
void thirdGreen() {
  for(uint16_t i=0; i<NUM_LEDS; i++) {
    topDrawerLED.setPixelColor(i, topDrawerLED.Color(0,0,0));
    secondDrawerLED.setPixelColor(i, secondDrawerLED.Color(0,0,0));
